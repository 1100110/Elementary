 ...
 * @ingroup Box
 */
void elm_box_pack_before(Evas_Object* obj, Evas_Object* subobj,
                                           Evas_Object* before);
 ...
 * @ingroup Box
 */
void elm_box_pack_after(Evas_Object* obj, Evas_Object* subobj,
                                          Evas_Object* after);
 ...
 * @ingroup Box
 */
void elm_box_padding_get(const Evas_Object* obj, Evas_Coord* horizontal,
                                                 Evas_Coord* vertical);
 ...
 * @ingroup Box
 */
void elm_box_align_get(const Evas_Object* obj, double* horizontal,
                                               double* vertical);
 ...
 * @ingroup Box
 */
void elm_box_layout_set(Evas_Object* obj, Evas_Object_Box_Layout cb,
 ...
 * @ingroup Box
 */
void elm_box_layout_transition(Evas_Object* obj, Evas_Object_Box_Data* priv,
                                                 void* data);
...
Elm_Box_Transition* elm_box_transition_new(const double duration,
          ...
          Ecore_Cb start_layout_free_data, Evas_Object_Box_Layout end_layout,
          void* end_layout_data, Ecore_Cb end_layout_free_data,
          Ecore_Cb transition_end_cb, void* transition_end_data);
