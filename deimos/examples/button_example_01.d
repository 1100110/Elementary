...
void btn_cursors_release_cb(void* data, Evas_Object* btn, void* ev)
{
   App_Data* app = data;
...
void btn_cursors_move_cb(void *data, Evas_Object *btn, void *ev)
{
   App_Data *app = data;
   double ax, ay;
...
void btn_options_cb(void *data, Evas_Object *btn, void *ev)
{
    char* ptr;
    double t;
    App_Data* app = data;
    string lbl = elm_object_text_get(btn);
...
int elm_main(int argc, char *argv[])
{
   ...
   evas_object_smart_callback_add(btn, "clicked", btn_options_cb, &data);
   ...
   evas_object_show(btn);
   evas_object_smart_callback_add(btn, "repeated", 
           btn_cursors_move_cb, &data);
   evas_object_smart_callback_add(btn, "unpressed", 
           btn_cursors_release_cb, &data);
   ...
   box2 = elm_box_add(win);
   elm_box_horizontal_set(box2, EINA_TRUE);
   evas_object_size_hint_weight_set(box2, 
           EVAS_HINT_EXPAND, EVAS_HINT_EXPAND);
   evas_object_size_hint_align_set(box2, 
