...
alias Evas_Object* function(void *data, Evas_Object *obj) *SlideshowItemGetFunc; /**< Image fetching class function for slideshow item classes. */
alias void function(void *data, Evas_Object *obj) *SlideshowItemDelFunc; /**< Deletion class function for slideshow item classes. */
 ...
 * field details.
 */
struct Elm_Slideshow_Item_Class
{
   struct Elm_Slideshow_Item_Class_Func
     {
 ...
 * @ingroup Slideshow
 */
Eina_List *elm_slideshow_transitions_get(const Evas_Object *obj);
 ...
 * @ingroup Slideshow
 */
char* elm_slideshow_transition_get(const Evas_Object *obj);
 ...
 * @ingroup Slideshow
 */
Eina_List *elm_slideshow_items_get(const Evas_Object *obj);
 ...
 * @ingroup Slideshow
 */
Elm_Object_Item *elm_slideshow_item_nth_get(const Evas_Object *obj, uint nth);
 ...
 * @ingroup Slideshow
 */
char *elm_slideshow_layout_get(const Evas_Object *obj);
 ...
 * @ingroup Slideshow
 */
Eina_List *elm_slideshow_layouts_get(const Evas_Object *obj);
 ...
 * @ingroup Slideshow
 */
uint elm_slideshow_count_get(const Evas_Object *obj);
