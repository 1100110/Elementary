 ...
 * @ingroup General
 */
void elm_object_item_part_text_set(Elm_Object_Item *it, const char *part,
                                                        const char *label);
 ...
 * @ingroup General
 */
char* elm_object_item_part_text_get(const Elm_Object_Item *it, const char *part);
 ...
 * @ingroup General
 */
void elm_object_item_signal_emit(Elm_Object_Item *it, const char *emission,
                                                      const char *source);
 ...
 * @ingroup General
 */
char* elm_object_item_tooltip_style_get(const Elm_Object_Item *it);
 ...
 * @ingroup General
 */
char* elm_object_item_cursor_get(const Elm_Object_Item *it);
 ...
 * @ingroup General
 */
char* elm_object_item_cursor_style_get(const Elm_Object_Item *it);
