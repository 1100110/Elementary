 ...
 * @ingroup Diskselector
 */
void elm_diskselector_bounce_get(const Evas_Object *obj, Eina_Bool *h_bounce, Eina_Bool *v_bounce);
 ...
 * @ingroup Diskselector
 */
void elm_diskselector_scroller_policy_get(const Evas_Object *obj, Elm_Scroller_Policy *policy_h, Elm_Scroller_Policy *policy_v);
 ...
 * @ingroup Diskselector
 */
Eina_List *elm_diskselector_items_get(const Evas_Object *obj);
 ...
 * @ingroup Diskselector
 */
Elm_Object_Item *elm_diskselector_item_append(Evas_Object *obj, const char *label, Evas_Object *icon, Evas_Smart_Cb func, const void *data);
