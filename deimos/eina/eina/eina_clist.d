...
void        eina_clist_add_after(Eina_Clist* elem, Eina_Clist* to_add);
 ...
 * @since 1.1.0
 */
void        eina_clist_add_before(Eina_Clist* elem, Eina_Clist* to_add);
 ...
 * @since 1.1.0
 */
void        eina_clist_add_head(Eina_Clist* list, Eina_Clist* elem);
 ...
 * @since 1.1.0
 */
void        eina_clist_add_tail(Eina_Clist* list, Eina_Clist* elem);
 ...
 * @since 1.1.0
 */
void        eina_clist_element_init(Eina_Clist* elem);
 ...
 * @since 1.1.0
 */
int         eina_clist_element_is_linked(Eina_Clist* elem);
 ...
 * @since 1.1.0
 */
void        eina_clist_remove(Eina_Clist* elem);
 ...
 * @since 1.1.0
 */
Eina_Clist* eina_clist_next(const Eina_Clist* list, const Eina_Clist* elem);
 ...
 * @since 1.1.0
 */
Eina_Clist* eina_clist_prev(const Eina_Clist* list, const Eina_Clist* elem);
 ...
 * @since 1.1.0
 */
Eina_Clist* eina_clist_head(const Eina_Clist* list);
 ...
 * @since 1.1.0
 */
Eina_Clist* eina_clist_tail(const Eina_Clist* list);
 ...
 * @since 1.1.0
 */
int         eina_clist_empty(const Eina_Clist* list);
 ...
 * @since 1.1.0
 */
void        eina_clist_init(Eina_Clist* list);
 ...
 * @since 1.1.0
 */
uint        eina_clist_count(const Eina_Clist* list);
 ...
 * @since 1.1.0
 */
void        eina_clist_move_tail(Eina_Clist* dst, Eina_Clist* src);
 ...
 * @since 1.1.0
 */
void        eina_clist_move_head(Eina_Clist* dst, Eina_Clist* src);
 ...
 */
//end static inline
//TODO fuck these fucking things!!
