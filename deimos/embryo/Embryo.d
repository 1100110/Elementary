...
immutable EMBRYO_VERSION_MAJOR = 1;
immutable EMBRYO_VERSION_MINOR = 2;

struct Embryo_Version
{
    int major;
    int minor;
    int micro;
...
__gshared Embryo_Version* embryo_version;
...
enum Embryo_Status
{
   ...
   alias uint Embryo_UCell;
   alias int  Embryo_Cell;

  /** An invalid cell reference */
immutable EMBRYO_CELL_NONE  = 0x7fffffff;
...
immutable EMBRYO_FUNCTION_NONE = 0x7fffffff; /* An invalid/non existent function */
immutable EMBRYO_FUNCTION_MAIN = -1;         /* Start at program entry point */
immutable EMBRYO_FUNCTION_CONT = -2;         /* Continue from last address */
 ...
 * @ingroup Embryo_Program_Creation_Group
 */
Embryo_Program* embryo_program_load(const char* file);
 ...
 */
void embryo_program_native_call_add(Embryo_Program* ep, const char* name,
                            Embryo_Cell (*func) (Embryo_Program* ep,
                            Embryo_Cell* params));
 ...
 */
Embryo_Cell embryo_program_variable_find(Embryo_Program* ep, const char* name);
 ...
 */
void embryo_program_error_set(Embryo_Program* ep, Embryo_Error error);
 ...
 * @ingroup Embryo_Error_Group
 */
Embryo_Error embryo_program_error_get(Embryo_Program* ep);
 ...
 * @ingroup Embryo_Error_Group
 */
const char* embryo_error_string_get(Embryo_Error error);
 ...
 * @ingroup Embryo_Data_String_Group
 */
void embryo_data_string_set(Embryo_Program* ep, const char* src,
 ...
 * @ingroup Embryo_Run_Group
 */
Embryo_Status embryo_program_run(Embryo_Program* ep, Embryo_Function func);
 ...
 * @ingroup Embryo_Parameter_Group
 */
int embryo_parameter_string_push(Embryo_Program* ep, const char* str);
 ...
 * @ingroup Embryo_Parameter_Group
 */
int embryo_parameter_cell_array_push(Embryo_Program* ep, Embryo_Cell* cells,
                                        int num);
