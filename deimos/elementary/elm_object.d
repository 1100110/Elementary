 ...
 * @ingroup Styles
 */
char* elm_object_style_get(const Evas_Object* obj);
 ...
 * @ingroup General
 */
void elm_object_signal_emit(Evas_Object* obj, const char* emission,
                                const char* source);
...
void elm_object_signal_callback_add(Evas_Object* obj, const char* emission,
                                    const char* source, Edje_Signal_Cb func,
                                    void* data);
 ...
 * @ingroup General
 */
void* elm_object_signal_callback_del(Evas_Object* obj, const char* emission,
                                    const char* source, Edje_Signal_Cb func);
