 ...
 * @ingroup Elm_Gesture_Layer
 */
struct Elm_Gesture_Taps_Info
{
   Evas_Coord   x, y; /**< Holds center point between fingers */
   uint n; /**< Number of fingers tapped           */
   uint timestamp; /**< event timestamp       */
}
 ...
 * @ingroup Elm_Gesture_Layer
 */
struct Elm_Gesture_Momentum_Info /* Report line ends, timestamps, and momentum computed        */
{
    ...
    uint tx; /**< Timestamp of start of final x-swipe */
    uint ty; /**< Timestamp of start of final y-swipe */

    Evas_Coord   mx; /**< Momentum on X */
    Evas_Coord   my; /**< Momentum on Y */

    uint n; /**< Number of fingers */
}
 ...
 * @ingroup Elm_Gesture_Layer
 */
struct Elm_Gesture_Line_Info   /* Report line ends, timestamps, and momentum computed      */
{
 ...
 * @ingroup Elm_Gesture_Layer
 */
struct Elm_Gesture_Rotate_Info
{
   Evas_Coord x, y; /**< Holds zoom center point reported to user      */
   Evas_Coord radius; /**< Holds radius between fingers reported to user */
 ...
 * @ingroup Elm_Gesture_Layer
 */
alias Evas_Event_Flags function(void *data, void *event_info)
