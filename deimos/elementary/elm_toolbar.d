...
struct Elm_Toolbar_Item_State;    /**< State of a Elm_Toolbar_Item. Can be created with elm_toolbar_item_state_add() and removed with elm_toolbar_item_state_del(). */
 ...
 * @ingroup Toolbar
 */
Elm_Object_Item *elm_toolbar_item_append(Evas_Object *obj, const char *icon,
 ...
 * @ingroup Toolbar
 */
Elm_Object_Item *elm_toolbar_item_prepend(Evas_Object *obj, const char *icon,
                    const char *label, Evas_Smart_Cb func, const void *data);
...
Elm_Object_Item *elm_toolbar_item_insert_before(Evas_Object *obj,
    Elm_Object_Item *before, const char *icon, const char *label, Evas_Smart_Cb func, const void *data);
...
Elm_Object_Item *elm_toolbar_item_insert_after(Evas_Object *obj,
                                Elm_Object_Item *after, const char *icon,
 ...
 * @ingroup Toolbar
 */
char *elm_toolbar_item_icon_get(const Elm_Object_Item *it);
 ...
 * @ingroup Toolbar
 */
Eina_Bool elm_toolbar_item_icon_memfile_set(Elm_Object_Item *it, const void *img,
 ...
 * @ingroup Toolbar
 */
Eina_Bool elm_toolbar_item_icon_file_set(Elm_Object_Item *it, const char *file,
                                         const char *key);
 ...
 * @ingroup Toolbar
 */
void elm_toolbar_align_set(Evas_Object *obj, double Ealign);
 ...
 * @ingroup Toolbar
 */
uint elm_toolbar_items_count(const Evas_Object *obj);
