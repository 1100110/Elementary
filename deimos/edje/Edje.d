...
immutable EDJE_VERSION_MAJOR = 1;
immutable EDJE_VERSION_MINOR = 2;
...
struct Edje_Version
{
 ...
 __gshared Edje_Version* edje_version;
...
enum Edje_Object_Table_Homogeneous_Mode
{
...
///**
 ...
 //*/
 //char *edje_external_param_type_str(Edje_External_Param_Type type) EINA_PURE;
...
///**
 ...
 //*
 //*/
 //char  *edje_fontset_append_get         (void);
...
///**
 ...
 //*/
 //char  *edje_object_data_get            (const Evas_Object *obj, const char *key);
...
///**
 ...
 //*/
 //char      *edje_load_error_str         (Edje_Load_Error error);
...
///**
 ...
 //* example), though.
 //*/
 //Evas_Object *edje_object_part_object_get   (const Evas_Object *obj, const char *part);
...
///**
 ...
 //*/
 //char  *edje_object_part_text_get           (const Evas_Object *obj, const char *part);
...
///**
 ...
 //* @since 1.2.0
 //*/
//char *edje_object_part_text_style_user_peek(const Evas_Object *obj, const char *part);
...
///**
 ...
 //*/
//char      *edje_object_part_text_selection_get           (const Evas_Object *obj, const char *part);
...
///**
 ...
 //*
 //*/
//Eina_List *edje_object_part_text_anchor_list_get         (const Evas_Object *obj, const char *part);
...
///**
 ...
 //*
 //*/
//Eina_List *edje_object_part_text_anchor_geometry_get     (const Evas_Object *obj, const char *part, const char *anchor);
...
///**
 ...
 //*
 //*/
//Eina_List *edje_object_part_text_item_list_get           (const Evas_Object *obj, const char *part);
...
///**
 ...
 //* "" for other states
 //*/
//char      *edje_object_part_state_get      (const Evas_Object *obj, const char *part, double *val_ret);
...
///**
 ...
 //*/
//Evas_Object *edje_object_part_table_child_get        (Evas_Object *obj, const char *part, unsigned int col, unsigned int row);
...
///**
 ...
 //*/
//uint edje_external_type_abi_version_get      (void) EINA_CONST;
...
///**
 ...
 //*/
 //Edje_External_Param_Info *edje_external_param_info_get   (const char *type_name);

///**
 //* Get the #Edje_External_Type that defines an EXTERNAL type registered with
 //* the name @p type_name.
 //*/
   //Edje_External_Type       *edje_external_type_get         (const char *type_name);

   //Eina_Bool               edje_module_load                (const char *module);
   //Eina_List        *edje_available_modules_get      (void);
   ...
   ///**
    ...
    //* @see edje_perspective_global_get()
    //*/
    //Edje_Perspective *edje_evas_global_perspective_get(const Evas *e);
   ///**
   ...
   ///**
    ...
    //* @see edje_object_perspective_set()
    //*/
    //Edje_Perspective *edje_object_perspective_get     (const Evas_Object *obj);
