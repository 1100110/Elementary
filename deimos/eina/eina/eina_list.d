...
import eina_config;
import eina_types;
import eina_iterator;
import eina_accessor;
import eina_magic;
 ...
 * touched.
 */
struct Eina_List_Accounting
{
   Eina_List   *last; /**< Pointer to the last element of the list - don't touch */
   uint count; /**< Number of elements of the list - don't touch */
   //EINA_MAGIC
}
 ...
 * @warning @p list must be a pointer to the first element of the list.
 */
void                 *eina_list_nth(const Eina_List *list, uint n);
 ...
 * @warning @p list must be a pointer to the first element of the list.
 */
Eina_List            *eina_list_nth_list(const Eina_List *list, uint n);
 ...
 * @warning @p list must be a pointer to the first element of the list.
 */
Eina_List            *eina_list_sort(Eina_List *list, uint limit, Eina_Compare_Cb func);
 ...
 * @warning @p list must be a pointer to the first element of the list.
 */
Eina_List   *eina_list_prev(const Eina_List *list);
 ...
 * @warning @p list must be a pointer to the first element of the list.
 */
void        *eina_list_data_set(Eina_List *list, const void *data);
 ...
 * @warning @p list must be a pointer to the first element of the list.
 */
uint eina_list_count(const Eina_List *list);
//end static inline
